...
namespace TheGamesDBApiWrapper.Data.ApiClasses
{
    ...
    public class Genres : Base.BaseApiClass, IGenres
    {
        ...
        public Genres(IServiceProvider provider, Models.Config.TheGamesDBApiConfigModel config, Domain.ITheGamesDBApiWrapperRestClientFactory factory, IAllowanceTracker allowanceTracker) : base(provider, config, factory, "Genres", allowanceTracker)
        {
        }
